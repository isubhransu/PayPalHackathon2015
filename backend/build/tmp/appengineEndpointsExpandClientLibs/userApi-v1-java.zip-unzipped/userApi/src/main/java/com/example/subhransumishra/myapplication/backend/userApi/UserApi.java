 ...
 * on 2015-10-11 at 15:55:45 UTC 
 * Modify at your own risk.
 */

package com.example.subhransumishra.myapplication.backend.userApi;
...
public class UserApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public GetUser getUser(java.lang.String phone) throws java.io.IOException {
    GetUser result = new GetUser(phone);
    initialize(result);
    return result;
  }

  public class GetUser extends UserApiRequest<com.example.subhransumishra.myapplication.backend.userApi.model.User> {

    private static final String REST_PATH = "user/{phone}";
     ...
     * @since 1.13
     */
    protected GetUser(java.lang.String phone) {
      super(UserApi.this, "GET", REST_PATH, null, com.example.subhransumishra.myapplication.backend.userApi.model.User.class);
    ...
    public GetUser setPhone(java.lang.String phone) {
      this.phone = phone;
      return this;
    }
   ...
   * @return the request
   */
  public InsertEvent insertEvent(java.lang.String name, java.lang.String desc) throws java.io.IOException {
    InsertEvent result = new InsertEvent(name, desc);
    initialize(result);
    return result;
  }

  public class InsertEvent extends UserApiRequest<Void> {

    private static final String REST_PATH = "user/{name}/{Desc}";

    /**
     * Create a request for the method "insertEvent".
     *
     * This request holds the parameters needed by the the userApi server.  After setting any optional
     * parameters, call the {@link InsertEvent#execute()} method to invoke the remote operation. <p>
     * {@link
     ...
     * @since 1.13
     */
    protected InsertEvent(java.lang.String name, java.lang.String desc) {
      super(UserApi.this, "POST", REST_PATH, null, Void.class);
    ...
    public InsertEvent setName(java.lang.String name) {
      this.name = name;
      return this;
    }

    @com.google.api.client.util.Key("Desc")
    ...
    public InsertEvent setDesc(java.lang.String desc) {
      this.desc = desc;
      return this;
    }
